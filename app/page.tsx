      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4 space-y-6">
        ...
        >
            ...
            <p className="text-stone-500 dark:text-stone-400 text-lg max-w-md mx-auto leading-relaxed">
                Your minimalist sanctuary for thoughts, dreams, and memories. Distraction-free and secure.
            </p>
        </motion.div>
    ...
    <div className="space-y-8 sm:space-y-12">
      ...
      <section className="flex flex-col items-center space-y-6 pt-2 pb-6">
        ...
        >
          ...
          <div className="relative flex items-center bg-white dark:bg-stone-900 rounded-2xl shadow-sm border border-stone-200 dark:border-stone-800 focus-within:border-rose-200 dark:focus-within:border-rose-800 focus-within:ring-4 focus-within:ring-rose-50 dark:focus-within:ring-rose-900/20 transition-all overflow-hidden">
            ...
            {(search || mood) && (
                 <button 
                    onClick={() => { setSearch(''); setMood(''); setShowFilters(false); }}
            ...
            <button 
              ...
              className={cn(
                  ...
                  showFilters || mood ? "bg-rose-50 dark:bg-rose-900/20 text-rose-600 dark:text-rose-400" : "text-stone-400 hover:bg-stone-50 dark:hover:bg-stone-800 hover:text-stone-600 dark:text-stone-500 dark:hover:text-stone-300"
              )}
            >
      ...
      {isLoading ? (
        <div className="flex flex-col items-center py-24 opacity-60">
          ...
          <span className="text-sm text-stone-400 dark:text-stone-500 font-medium animate-pulse">Gathering memories...</span>
        </div>
        ...
        >
          {hasActiveFilters ? (
              <div className="space-y-4">
                  <div className="mx-auto w-16 h-16 bg-stone-50 dark:bg-stone-900 rounded-full flex items-center justify-center text-2xl">🔍</div>
                  <h3 className="text-lg font-serif font-medium text-stone-800 dark:text-stone-100">No matches found</h3>
                  <p className="text-stone-500 dark:text-stone-400 text-sm">Try adjusting your search or filters.</p>
                  <button onClick={() => { setSearch(''); setMood(''); }} className="text-rose-600 dark:text-rose-400 text-sm font-medium hover:underline">Clear all filters</button>
              </div>
          ) : (
              <div className="relative p-8 md:p-12 bg-white dark:bg-stone-900 rounded-3xl border border-dashed border-stone-200 dark:border-stone-800 max-w-lg mx-auto shadow-sm">
                ...
                <h3 className="text-2xl font-serif font-bold text-stone-800 dark:text-stone-100 mb-3">A fresh page awaits</h3>
                <p className="text-stone-500 dark:text-stone-400 mb-8 max-w-xs mx-auto leading-relaxed">
                    The best time to start writing your story is now. Capture a thought, a feeling, or a moment.
                </p>
                <Link 
                    href="/entry/new"
